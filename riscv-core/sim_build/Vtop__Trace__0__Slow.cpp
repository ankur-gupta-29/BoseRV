...
VL_ATTR_COLD void Vtop___024root__trace_init_sub__TOP__0(Vtop___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declBus(c+6,0,"a",-1, VerilatedTraceSigDirection::INPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1, 31,0);
    ...
    tracep->declBus(c+8,0,"op",-1, VerilatedTraceSigDirection::INPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1, 3,0);
...
VL_ATTR_COLD void Vtop___024root__trace_full_0_sub_0(Vtop___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->fullCData(oldp+3,(vlSelfRef.op),4);
    bufp->fullIData(oldp+4,(vlSelfRef.result),32);
    bufp->fullBit(oldp+5,(vlSelfRef.zero));
    bufp->fullIData(oldp+6,(vlSelfRef.alu__DOT__a),32);
    bufp->fullIData(oldp+7,(vlSelfRef.alu__DOT__b),32);
    bufp->fullCData(oldp+8,(vlSelfRef.alu__DOT__op),4);
    bufp->fullIData(oldp+9,(vlSelfRef.alu__DOT__result),32);
