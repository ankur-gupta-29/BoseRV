...
void Vtop___024root__trace_chg_0_sub_0(Vtop___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->chgCData(oldp+15,(vlSelfRef.top__DOT__wb_sel),2);
    bufp->chgBit(oldp+16,(vlSelfRef.top__DOT__branch));
    bufp->chgBit(oldp+17,(vlSelfRef.top__DOT__jump));
    bufp->chgBit(oldp+18,(vlSelfRef.top__DOT__jalr));
    bufp->chgBit(oldp+19,(vlSelfRef.top__DOT__auipc));
    bufp->chgBit(oldp+20,(vlSelfRef.top__DOT__lui));
    bufp->chgIData(oldp+21,(vlSelfRef.top__DOT__rs1_data),32);
    bufp->chgIData(oldp+22,(vlSelfRef.top__DOT__rs2_data),32);
    bufp->chgIData(oldp+23,(vlSelfRef.top__DOT__alu_b_in),32);
    bufp->chgIData(oldp+24,(vlSelfRef.top__DOT__alu_result),32);
    bufp->chgBit(oldp+25,(vlSelfRef.top__DOT__alu_zero));
    bufp->chgIData(oldp+26,(vlSelfRef.top__DOT__mem_read_data),32);
    bufp->chgIData(oldp+27,(vlSelfRef.top__DOT__writeback_data),32);
    bufp->chgBit(oldp+28,(vlSelfRef.top__DOT__branch_taken));
    bufp->chgIData(oldp+29,(vlSelfRef.top__DOT__branch_target),32);
    bufp->chgIData(oldp+30,(vlSelfRef.top__DOT__jump_target),32);
