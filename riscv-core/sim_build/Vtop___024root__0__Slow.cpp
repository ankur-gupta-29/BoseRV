...
#endif
            VL_FATAL_MT("/home/ankur/workspace/BoseRV/riscv-core/src/alu.v", 12, "", "Settle region did not converge after 100 tries");
        }
...
VL_ATTR_COLD void Vtop___024root___ctor_var_reset(Vtop___024root* vlSelf) {
    ...
    vlSelf->alu__DOT__a = VL_SCOPED_RAND_RESET_I(32, __VscopeHash, 13884063359388093222ull);
    vlSelf->alu__DOT__b = VL_SCOPED_RAND_RESET_I(32, __VscopeHash, 11383723558786427759ull);
    vlSelf->alu__DOT__op = VL_SCOPED_RAND_RESET_I(4, __VscopeHash, 53691447768023569ull);
    vlSelf->alu__DOT__result = VL_SCOPED_RAND_RESET_I(32, __VscopeHash, 15636116320148287157ull);
