...
Cohesion: 0.07
Nodes (27): BoseRV — Module 4 Hazard Unit Test (test_hazard.py) ============================, A7: rd=x0 must NEVER trigger forwarding (x0 is always 0), A8: reg_write=0 suppresses forwarding even if rd matches, B1: No stall — non-load instruction in EX stage, B2: LW followed by instruction that reads the loaded register (rs1), B3: LW followed by instruction that reads the loaded register (rs2), B4: LW in EX but the next instruction reads DIFFERENT registers — no stall, B5: LW to x0 never causes a stall (x0 is always 0, no real dependence) (+19 more)
...
- **Thin community `Community 36`** (2 nodes): `Vtb_top__Syms.h`, `name()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 37`** (2 nodes): `Vtb_fetch__Syms.h`, `name()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 38`** (2 nodes): `Vtb_decoder__Syms.h`, `name()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 39`** (2 nodes): `Vtb_if_id.h`, `eval_end_step()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 40`** (2 nodes): `Vtb_ex_mem___024root.h`, `Vtb_ex_mem___024root()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 41`** (2 nodes): `Vtb_mem_wb.h`, `eval_end_step()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 42`** (2 nodes): `Vtb_fetch___024root.h`, `Vtb_fetch___024root()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 43`** (2 nodes): `Vtb_decoder___024root.h`, `Vtb_decoder___024root()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 44`** (2 nodes): `Vtb_id_ex___024root.h`, `Vtb_id_ex___024root()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 45`** (2 nodes): `Vtb_ex_mem.h`, `eval_end_step()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 46`** (2 nodes): `Vtb_if_id__Syms.h`, `name()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 47`** (2 nodes): `Vtb_id_ex.h`, `eval_end_step()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 48`** (2 nodes): `Vtb_id_ex__Syms.h`, `name()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 49`** (2 nodes): `Vtb_alu___024root.h`, `Vtb_alu___024root()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 50`** (2 nodes): `Vtb_top___024root.h`, `Vtb_top___024root()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 51`** (2 nodes): `Vtb_ex_mem__Syms.h`, `name()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 52`** (2 nodes): `Vtb_mem_wb___024root.h`, `Vtb_mem_wb___024root()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 53`** (2 nodes): `Vtb_if_id___024root.h`, `Vtb_if_id___024root()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 54`** (2 nodes): `Vtb_alu__Syms.h`, `name()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 55`** (2 nodes): `Vtb_mem_wb__Syms.h`, `name()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 56`** (2 nodes): `Vtb_alu.h`, `eval_end_step()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 57`** (2 nodes): `Vtop__Syms.h`, `name()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 58`** (2 nodes): `Vtop___024root.h`, `Vtop___024root()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 59`** (2 nodes): `Vtop.h`, `eval_end_step()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 60`** (1 nodes): `decoder.v`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
